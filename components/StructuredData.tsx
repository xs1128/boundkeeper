...
const faqItems = [
  {
    question: "勞權濾網是什麼？",
    answer: "勞權濾網是面向台灣受雇勞工的工具，協助分析收到的主管訊息，提供風險提示、法規參考、回覆改進建議與後續行動方向。",
  },
  {
    question: "這是法律意見或律師代理嗎？",
    answer: "不是。勞權濾網使用 AI 提供一般性勞動法資訊與溝通建議，不構成法律意見。重大決定請諮詢 1955 勞工諮詢申訴專線或專業律師。",
  },
  {
    question: "如何使用勞權濾網分析主管訊息？",
